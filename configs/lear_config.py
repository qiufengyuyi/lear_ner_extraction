...
lear_config = {
    ...
    'bert_slot_file_name':"base_slot_list",
    ...
    # "teacher_bert_config_path":"bert_config.json",
    # "student_bert_config_path":"student_bert_config.json",
    'bert_init_checkpoints':'bert_model.ckpt',
    "lear_model_dir":os.path.join('output','model','lear','checkpoint'),
    "lear_model_pb":os.path.join('output','model','lear','saved_model'),
    # "large_bert_mrc_model_dir":os.path.join('output','model','large_bert_mrc_model','checkpoint'),
    # "large_bert_mrc_model_pb":os.path.join('output','model','large_bert_mrc_model','saved_model'),
    ...
    # "amp_bert_mrc_focal_loss_model_dir":os.path.join('output','model','amp_bert_mrc_focal_loss_model','checkpoint'),
    # "amp_bert_mrc_focal_loss_model_pb":os.path.join('output','model','amp_bert_mrc_focal_loss_model','saved_model'),
    # "the_bert_mrc_focal_loss_model_dir":os.path.join('output','model','the_bert_mrc_focal_loss_model','checkpoint'),
    # "the_bert_mrc_focal_loss_model_pb":os.path.join('output','model','the_bert_mrc_focal_loss_model','saved_model'),
    # "suc_bert_mrc_focal_loss_model_dir": os.path.join('output', 'model', 'suc_bert_mrc_focal_loss_model', 'checkpoint'),
    # "suc_bert_mrc_focal_loss_model_pb": os.path.join('output', 'model', 'suc_bert_mrc_focal_loss_model', 'saved_model'),
    # "minilm_ta_bert_mrc_focal_loss_model_dir": os.path.join('output', 'model', 'minilm_ta_bert_mrc_focal_loss_model', 'checkpoint'),
    # "minilm_ta_mrc_focal_loss_model_pb": os.path.join('output', 'model', 'minilm_ta_bert_mrc_focal_loss_model', 'saved_model'),
    # "minilm_student_bert_mrc_focal_loss_model_dir": os.path.join('output', 'model', 'minilm_student_bert_mrc_focal_loss_model', 'checkpoint'),
    # "minilm_student_mrc_focal_loss_model_pb": os.path.join('output', 'model', 'minilm_student_bert_mrc_focal_loss_model', 'saved_model'),
}
